import $ from "jquery";
import { showSummary } from "./summary-basket";
...
export const arrivalClick = () => {
  $(".click-arrival").click((e) => {
    ...
    if ($("#input-arrival-date").val() < todayDate) {
      ...
      // const inputArrivalDate = arrivalValue.substring();
      ...
      // console.log(ddArrivalInput);

      // console.log(mmArrivalInput);

      // console.log(yyyyArrivalInput);

      // const mm = String(inputArrivalDate.getMonth() + 1).padStart(2, "0");

      // const yyyy = inputArrivalDate.getFullYear();
      ...
      //   <span class="departure-from-input-info">Data wyjazdu ze SPA: </span><span class="departure-from-input-value">${$(
